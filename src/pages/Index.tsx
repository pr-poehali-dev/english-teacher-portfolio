      ...
      <section id="about" className="py-20 px-6 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
            <p>
              Добро пожаловать! Меня зовут [Имя], и я преподаю английский язык более 8 лет. 
              Моя страсть к преподаванию началась во время обучения в университете, где я открыл для себя 
              удивительный мир межкультурной коммуникации.
            </p>
            <p>
