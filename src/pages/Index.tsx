  ...
  const qualifications = [
    {
      ...
      institution: 'Череповецкий государственный университет',
      year: '2027'
    },
    {
      degree: 'Преподаватель английского языка',
      field: 'Опыт преподавания',
      institution: 'Череповецкий лесомеханический колледж',
      year: 'с 2025 года'
    }
  ];
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-fade-in">
              ...
              <img
                src="https://cdn.poehali.dev/files/634a0cbd-e780-4724-83e9-9ccd1591df8b.jpg"
                alt="English Teacher"
